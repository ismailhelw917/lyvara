...
async function main() {
  try {
    // Read the JSON file
    const jsonData = fs.readFileSync('/home/ubuntu/upload/pasted_content_4.txt', 'utf-8');
    const data = JSON.parse(jsonData);

    // Use category_results array from jewelry accessories category
    ...
    console.log(`📦 Found ${sourceArray.length} jewelry accessories products in JSON\n`);
