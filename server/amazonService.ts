...
const MOCK_JEWELRY_PRODUCTS: AmazonSearchResult[] = [
  // Gold Necklaces
  {
    ...
    rating: 4.8,
    reviewCount: 2341,
    affiliateUrl: "https://www.amazon.com/dp/B08GOLD001?tag=aurumjewels-20",
    category: "necklaces",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 1876,
    affiliateUrl: "https://www.amazon.com/dp/B08GOLD002?tag=aurumjewels-20",
    category: "necklaces",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 3102,
    affiliateUrl: "https://www.amazon.com/dp/B08GOLD003?tag=aurumjewels-20",
    category: "necklaces",
    metalType: "gold",
  ...
  // Silver Necklaces
  {
    ...
    rating: 4.9,
    reviewCount: 5621,
    affiliateUrl: "https://www.amazon.com/dp/B08SILV001?tag=aurumjewels-20",
    category: "necklaces",
    metalType: "silver",
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 2890,
    affiliateUrl: "https://www.amazon.com/dp/B08SILV002?tag=aurumjewels-20",
    category: "necklaces",
    metalType: "silver",
  ...
  // Gold Bracelets
  {
    ...
    rating: 4.8,
    reviewCount: 1234,
    affiliateUrl: "https://www.amazon.com/dp/B08BRAC001?tag=aurumjewels-20",
    category: "bracelets",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.4,
    reviewCount: 4521,
    affiliateUrl: "https://www.amazon.com/dp/B08BRAC002?tag=aurumjewels-20",
    category: "bracelets",
    metalType: "gold",
  ...
  // Rose Gold Bracelets
  {
    ...
    rating: 4.7,
    reviewCount: 987,
    affiliateUrl: "https://www.amazon.com/dp/B08BRAC003?tag=aurumjewels-20",
    category: "bracelets",
    metalType: "rose_gold",
  ...
  // Gold Rings
  {
    ...
    rating: 4.9,
    reviewCount: 876,
    affiliateUrl: "https://www.amazon.com/dp/B08RING001?tag=aurumjewels-20",
    category: "rings",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 3456,
    affiliateUrl: "https://www.amazon.com/dp/B08RING002?tag=aurumjewels-20",
    category: "rings",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 654,
    affiliateUrl: "https://www.amazon.com/dp/B08RING003?tag=aurumjewels-20",
    category: "rings",
    metalType: "rose_gold",
  ...
  // Silver Rings
  {
    ...
    rating: 4.5,
    reviewCount: 2109,
    affiliateUrl: "https://www.amazon.com/dp/B08RING004?tag=aurumjewels-20",
    category: "rings",
    metalType: "silver",
  ...
  // Gold Earrings
  {
    ...
    rating: 4.7,
    reviewCount: 1876,
    affiliateUrl: "https://www.amazon.com/dp/B08EARR001?tag=aurumjewels-20",
    category: "earrings",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 3210,
    affiliateUrl: "https://www.amazon.com/dp/B08EARR002?tag=aurumjewels-20",
    category: "earrings",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 4567,
    affiliateUrl: "https://www.amazon.com/dp/B08EARR003?tag=aurumjewels-20",
    category: "earrings",
    metalType: "gold",
  ...
  // Silver Earrings
  {
    ...
    rating: 4.8,
    reviewCount: 8901,
    affiliateUrl: "https://www.amazon.com/dp/B08EARR004?tag=aurumjewels-20",
    category: "earrings",
    metalType: "silver",
  ...
  // Pendants
  {
    ...
    rating: 4.5,
    reviewCount: 1543,
    affiliateUrl: "https://www.amazon.com/dp/B08PEND001?tag=aurumjewels-20",
    category: "pendants",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 2876,
    affiliateUrl: "https://www.amazon.com/dp/B08PEND002?tag=aurumjewels-20",
    category: "pendants",
    metalType: "silver",
  ...
  // Sets
  {
    ...
    rating: 4.6,
    reviewCount: 2341,
    affiliateUrl: "https://www.amazon.com/dp/B08SETS001?tag=aurumjewels-20",
    category: "sets",
    metalType: "gold",
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 1098,
    affiliateUrl: "https://www.amazon.com/dp/B08SETS002?tag=aurumjewels-20",
    category: "sets",
    metalType: "rose_gold",
  ...
  // White Gold
  {
    ...
    rating: 4.9,
    reviewCount: 765,
    affiliateUrl: "https://www.amazon.com/dp/B08WGOL001?tag=aurumjewels-20",
    category: "earrings",
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 432,
    affiliateUrl: "https://www.amazon.com/dp/B08WGOL002?tag=aurumjewels-20",
    category: "rings",
    metalType: "white_gold",
...
export async function fetchJewelryProducts(
  ...
  const associateTag = process.env.AMAZON_ASSOCIATE_TAG || "aurumjewels-20";
...
export async function fetchAllCategories(associateTag = "aurumjewels-20"): Promise<InsertProduct[]> {
